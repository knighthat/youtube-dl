...
public class JsonImpl extends CommandImpl implements Json {

    @NotNull
    static final Gson GSON = new Gson();

    public static @NotNull Json.Builder builder( @NotNull String url ) { return new Builder( url ); }
    ...
    public static class  Builder extends CommandImpl.Builder implements Json.Builder {
        ...
        public @NotNull Json build() {
            return new JsonImpl( getUrl(), getFlags(), getHeaders(), getUserAgent(), getGeoConfig() );
        }
